...
| --- | --- | --- | --- | --- |
| eval_good | pass | pass | yes | aQ=0.88 fP=0.83 |
...
| eval_off_topic | fail | fail | yes | aQ=0.02 fP=0.07 - The files and report do not answer the instructions (98% confident). |
| eval_mixed_topic_ambiguous | pass_with_notes | pass_with_notes | yes | aQ=0.75 fP=0.71 - The CSV has all five required columns and 9 data rows (>=8), each with title, source, url, published_at, and summary. Most rows are clearly AI |
...
_Generated 2026-09-22T09:20:50.118Z._
