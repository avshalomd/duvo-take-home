...
const SENTENCES: Record<OAuthErrorCode, string> = {
  ...
  unreachable: "The connection could not be reached; check its address and try again",
  unreadable: "The connection's sign-in details could not be read; try again later",
  no_sign_in_needed: "This connection works without signing in, so it needs neither a sign-in nor a token",
  token_only: "This connection does not offer sign-in; add a token instead",
  other_server: "The connection's sign-in details name another service, so it cannot be signed in to safely",
  register_by_hand: "This connection only signs in apps registered by hand, so it cannot be connected this way; add a token instead",
  registration_refused: "The connection refused to register this app; try again later, or add a token instead",
  unsupported: "This connection's sign-in is not one this app supports; add a token instead",
  token_refused: "The connection did not accept the sign-in; start it again",
