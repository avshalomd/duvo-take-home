...
// The slash and the start of a name an automation can have: the list opens. What counts as a command once sent is
// parseCommand's: any word after the slash (F14).
const PARTIAL = /^\s*\/([a-z][a-z0-9-]*)?$/i;
