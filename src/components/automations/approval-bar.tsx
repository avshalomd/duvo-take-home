...
// (from canApprove on the server) says what is missing.
export function ApprovalBar({ automationId, progress, allowed, reason }: { automationId: string; progress: ApprovalProgress; allowed: boolean; reason: string | null }) {
